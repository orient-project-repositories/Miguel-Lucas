    ...
    if((suc_1==0)&&(suc_2==0)&&(suc_3==0)){
      ...
      while(1){
        ...
        if((suc_1==0)&&(suc_2==0)&&(suc_3==0)){
          ...
          //Force-Load
          curforce1=Dxl.readWord(1, 40);
          curforce2=Dxl.readWord(2, 40);
          curforce3=Dxl.readWord(3, 40);
          ...
          //Force
          SerialUSB.print(curforce1);
          SerialUSB.print(" ");
          SerialUSB.print(curforce2);
          SerialUSB.print(" ");
          SerialUSB.print(curforce3);
          SerialUSB.print("\n");
